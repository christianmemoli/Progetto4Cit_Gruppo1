...
do
{
		...
		do
		{
			...
			switch (scelta)
			{
				...
				case 0 :
					...
					break;//Uscita case 0(Switch internoi) di case 0 (Grande switch)
				...
				case 1 :
					...
					break;//Uscita case 1(Switch internoi) di case 0 (Grande switch)
				...
				case 2:
						...
						System.out.println("Inserire un nuovo numero per accedere nuovamente nel menù:");
					break;//Uscita case 2(Switch interno) di case 0 (Grande switch)
	...
	}//Chiusura primo Switch di Do Grande
	
}//Chiusura Do  Grande
while(scelta == 0 || scelta == 1 || scelta ==2 || scelta == 3 || scelta == 4);
System.out.println("Siete usciti dal menù grazie e buona giornata");
		
	}//Chiusura Public Static Class
}//Chiusura Public Class
